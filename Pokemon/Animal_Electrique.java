public class Animal_Electrique extends A_Type_Base {
    public Animal_Electrique(String type, String nom, int niveau, double vie, double attaque, double defence, String nomCompetence) {
    ...
    public void utiliserCompetence(A_Type_Base cible) {
        System.out.println(this.getNom() + " 使用了电系技能 " + this.nomCompetence + " 攻击 " + cible.getNom() + "!");
