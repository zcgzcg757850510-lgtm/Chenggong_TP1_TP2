public class Animal_plante extends A_Type_Base {
    public Animal_plante(String type, String nom, int niveau, double vie, double attaque, double defence, String nomCompetence) {
    ...
    public void utiliserCompetence(A_Type_Base cible) {
        System.out.println(this.getNom() + " 使用了草系技能 " + this.nomCompetence + " 攻击 " + cible.getNom() + "!");
